...
median_income = st.slider("Renda Média - multiplo de US$ 10k", 0.5, 15.0, 4.5, 0.5)
...
rooms_per_household = st.number_input("Cômodos por Domicílio", value=7)
bedrooms_per_room = st.number_input("Razão de Quartos por Cômodos", value=0.2)
